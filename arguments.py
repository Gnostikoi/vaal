...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='semeval', help='Name of the dataset used.')
    ...
    parser.add_argument('--log_name', type=str, default='perf.log', help='Final performance of the models will be saved with this name')
